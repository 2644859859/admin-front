                ...
                <el-form-item prop="code">
                  <el-input type="text" v-model="formLogin.code" placeholder="- - - -">
                    ...
                    <template slot="append">
                      <img v-lazy="imageCode" :src="imageCode" @click="getImage" class="captcha-code"/>
                    </template>
                  </el-input>
                </el-form-item>

                <el-form-item prop="rememberMe">
                  <el-checkbox type="checkbox" checked label="请记住我" v-model="formLogin.rememberMe" />
                </el-form-item>
        ...
        methods: {
            ...
            submit () {
                this.$refs.loginForm.validate((valid) => {
                    if (valid) {
                        if(this.formLogin.rememberMe == false){
                            util.cookies.set('rememberMe',"",{expires:365});
                        }else{
                            util.cookies.set('rememberMe', this.formLogin.rememberMe,{expires:365});
                        }
                        this.login({
                            vm: this,
