        ...
        <el-row>
            <el-col :span="24" style='margin-top:5px;'>
                ...
                <el-table :key='tableKey' size="mini" :data="list" v-loading.body="listLoading" border fit
                    ...
                    <el-table-column prop="updateTime" align="center" label="最后更新时间" width="140"></el-table-column>
                    ...
                    <el-table-column align="center" label="操作" width="300">
                        <template scope="scope">
                            ...
                            <el-button v-if="scope.row.flowTaskName !=null" size="mini" type="info"
...
<script>
    ...
    import {
        findHisByBusId,viewProcessInstanceImage
    ...
    export default {
        ...
        methods: {
            ...
            handleViewPic(row){
                viewProcessInstanceImage({busKey:row.id}).then((res) => {
                    if(res && res.code =='200'){
            ...
            handleViewCheckHis(row){
                findHisByBusId({busId:row.id}).then((res) => {
                    if(res && res.code =='200'){
